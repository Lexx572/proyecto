...
public class DaoPerson {
    ...
    private final String INSERT_PERSON = "INSERT INTO person (name, lastname, age, email, curp, birthday, image)" +
            "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private final String UPDATE_PERSON = "UPDATE person SET name = ?, lastname = ?, age = ?, email = ?, curp = ?" +
            "WHERE id = ?";
    ...
    public boolean savePerson(BeanPerson person, InputStream image){
        try {
            ...
            pstm.setString(5, person.getCurp());
